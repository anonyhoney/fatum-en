            ...
            else if ((message.Type == Telegram.Bot.Types.Enums.MessageType.Text) && (banned.ContainsKey(message.Chat.Id.ToString()) == false))
            {
                ...
                else if ((message.Text == "/getattractor"))
                {
                    ...
                    try
                    {
                        ...
                        await Bot.SendTextMessageAsync(message.Chat.Id, "Wait a minute. It will take a while.");
                ...
                else if ((message.Text == "/getrepeller"))
                {
                    ...
                    try
                    {
                        ...
                        if (incoords[2] >= 0.9)
                        {
                            mesg = "Repeller is invalid! density: " + incoords[2].ToString("#0.00", System.Globalization.CultureInfo.InvariantCulture)
  + " radius: " + incoords[3].ToString("#0.00", System.Globalization.CultureInfo.InvariantCulture) + " meters";
                        }
                        else if (incoords[2] < 0.6)
                        {
                            mesg = "Repeller generated. density: " + incoords[2].ToString("#0.00", System.Globalization.CultureInfo.InvariantCulture)
+ " radius: " + incoords[3].ToString("#0.00", System.Globalization.CultureInfo.InvariantCulture) + " meters";
                        }
                        else
                        {
                            mesg = "Repeller generated. density: " + incoords[2].ToString("#0.00", System.Globalization.CultureInfo.InvariantCulture) + " (Weak) "
                        + " radius: " + incoords[3].ToString("#0.00", System.Globalization.CultureInfo.InvariantCulture) + " meters";
                        }
                        ...
                        System.IO.File.AppendAllText(logpath, message.Date.ToString() + " " + message.From.Id.ToString() + " " + buf1
                                + "created repeller point: " + buf + Environment.NewLine + mesg + Environment.NewLine);
                        //logging
                    }
                    catch (Exception e) { Console.WriteLine("getrepeller command processing error" + Environment.NewLine + e.Message.ToString()); }
                }
                else if ((message.Text == "/getpair"))
                {
                    ...
                    try
                    {
                        ...
                        if (incoords[5] >= 0.9)
                        {
                            mesg2 = "Repeller is invalid! density: " + incoords[5].ToString("#0.00", System.Globalization.CultureInfo.InvariantCulture)
 + " radius: " + incoords[6].ToString("#0.00", System.Globalization.CultureInfo.InvariantCulture) + " meters";
                        }
                        else if (incoords[5] < 0.6)
                        {
                            mesg2 = "Repeller generated. density: " + incoords[5].ToString("#0.00", System.Globalization.CultureInfo.InvariantCulture)
+ " radius: " + incoords[6].ToString("#0.00", System.Globalization.CultureInfo.InvariantCulture) + " meters";
                        }
                        else
                        {
                            mesg2 = "Repeller generated. density: " + incoords[5].ToString("#0.00", System.Globalization.CultureInfo.InvariantCulture) + " (Weak) "
                        + " radius: " + incoords[6].ToString("#0.00", System.Globalization.CultureInfo.InvariantCulture) + " meters";
                        }
                        issent = false;
                        rtr = 0;
                        ...
                        System.IO.File.AppendAllText(logpath, message.Date.ToString() + " " + message.From.Id.ToString() + " " + buf1
                                + "created attractor-repeller pair: " + buf + Environment.NewLine + mesg1 + Environment.NewLine + mesg2 + Environment.NewLine);
                        //logging
                    }
                ...
                else if ((message.Text == "/setdefault"))
                {
                    try
                    {
                        ...
                        await Bot.SendTextMessageAsync(message.Chat.Id, "Reset completed.");
                        //logging
                        string buf1 = "";
                        if (message.From.FirstName != null) { buf1 = message.From.FirstName.ToString() + " "; }
                        if (message.From.LastName != null) { buf1 += message.From.FirstName.ToString() + " "; }
                ...
                else if (message.Text == "/test")
                {
                    ...
                    await Bot.SendTextMessageAsync(message.Chat.Id, "Fatum-2 is online");
                ...
                else if ((message.Text.Contains("mnts") == true) && (message.Text.Contains(mntskey) == true))
                {
                    ...
                    await Bot.SendTextMessageAsync(message.Chat.Id, "Key Accepted. Maintenance session started for user " + message.From.FirstName);
                }
        ...
        static private async Task bw_DoWork(TelegramBotClient Bot)
        {
            ...
            while (true)
            {
                ...
                catch (Exception e1) { Console.WriteLine("Iteration failed (probably connection error)" + Environment.NewLine + e1.Message.ToString()); }
            }
        }
